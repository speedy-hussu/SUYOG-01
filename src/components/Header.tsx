            ...
            <form>
              <div className="relative">
                ...
                <input
                  ...
                  className="dark:bg-dark-900 h-8 w-full rounded-lg border border-gray-400 bg-transparent pl-12 pr-14 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-gray-600 focus:outline-hidden  dark:border-gray-800 dark:bg-gray-900 dark:bg-white/[0.03] dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800 xl:w-[430px]"
                />
